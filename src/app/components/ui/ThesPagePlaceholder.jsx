...
const ThesPagePlaceholder = () => {
  return (
    <div className='flex w-full gap-8 justify-center pt-24'>
      <div className='bg-gradient-to-b from-amber-600 to-white bg-clip-text text-transparent flex flex-col w-1/3'>
        <h2 className='text-5xl font-bold'>Welcome to the <span className='text-white'>Collegiate Resource Hub</span> Thesaurus Page.</h2>
