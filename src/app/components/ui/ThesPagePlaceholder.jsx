...
const ThesPagePlaceholder = () => {
  return (
    <>
      <div className='md:hidden absolute top-0 w-full h-[2rem] bg-amber-500 border-t border-b-2 border-neutral-300' />
      <div className='flex w-full gap-8 justify-center items-center pt-6 mx-4 mt-12 md:mt-0'>
